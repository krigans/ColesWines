...
{
    /// <summary>
    /// Interaction logic for DisplayWhiteWine.xaml
    /// </summary>
    public partial class DisplayWhiteWine : Window
    {
        public static readonly DependencyProperty PageLeftEnabledProperty = DependencyProperty.Register(
           "PageLeftEnabled", typeof(bool), typeof(DisplayWhiteWine), new PropertyMetadata(false));

        public static readonly DependencyProperty PageRightEnabledProperty = DependencyProperty.Register(
            "PageRightEnabled", typeof(bool), typeof(DisplayWhiteWine), new PropertyMetadata(false));


        public static readonly RoutedEvent HandPointerEnterEvent = EventManager.RegisterRoutedEvent(
        "HandPointerEnter", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayWhiteWine));

        public static readonly RoutedEvent HandPointerLeaveEvent = EventManager.RegisterRoutedEvent(
            "HandPointerLeave", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayWhiteWine));
        ...
        private void AmberleyEstateButton_Click(object sender, RoutedEventArgs e)
        {
            unregisterEvents();
            var displayDetails = new DisplayWhiteWineDetails();
            this.Close();
            displayDetails.Show();
            
        }

        private void ValleyChardonnayButton_Click(object sender, RoutedEventArgs e)
        {
            unregisterEvents();
            var DisplayChardonnay = new DisplayValleyChardonnay();
            this.Close();
            DisplayChardonnay.Show();
            
        }

        private void ValleyRieslingButton_Click(object sender, RoutedEventArgs e)
        {
            unregisterEvents();
            var displayRiesling = new DisplayValleyRiesling();
            this.Close();
            displayRiesling.Show();
            
        }

        private void BanrockMoscatoButton_Click(object sender, RoutedEventArgs e)
        {
            unregisterEvents();
            var displayMoscato = new DisplayBanrockMoscato();
            this.Close();
            displayMoscato.Show();
