...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class Help : Window
    {
        public static readonly DependencyProperty PageLeftEnabledProperty = DependencyProperty.Register(
          "PageLeftEnabled", typeof(bool), typeof(Help), new PropertyMetadata(false));

        public static readonly DependencyProperty PageRightEnabledProperty = DependencyProperty.Register(
            "PageRightEnabled", typeof(bool), typeof(Help), new PropertyMetadata(false));
        ...
        public Help()
        {
            ...
            BindingOperations.SetBinding(this.kinectRegionHelp, KinectRegion.KinectSensorProperty, regionSensorBinding);
        }
