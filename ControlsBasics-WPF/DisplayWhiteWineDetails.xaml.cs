...
{
    /// <summary>
    /// Interaction logic for DisplayWhiteWineDetails.xaml
    /// </summary>
    public partial class DisplayWhiteWineDetails : Window
    {
        public static readonly DependencyProperty PageLeftEnabledProperty = DependencyProperty.Register(
           "PageLeftEnabled", typeof(bool), typeof(DisplayWhiteWineDetails), new PropertyMetadata(false));

        public static readonly DependencyProperty PageRightEnabledProperty = DependencyProperty.Register(
            "PageRightEnabled", typeof(bool), typeof(DisplayWhiteWineDetails), new PropertyMetadata(false));

        public static readonly RoutedEvent HandPointerEnterEvent = EventManager.RegisterRoutedEvent(
       "HandPointerEnter", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayWhiteWineDetails));

        public static readonly RoutedEvent HandPointerLeaveEvent = EventManager.RegisterRoutedEvent(
            "HandPointerLeave", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayWhiteWineDetails));
        ...
        public DisplayWhiteWineDetails()
        {
            InitializeComponent();
        ...
        {
            unregisterEvents();
            var displayDetails = new DisplayWhiteWine();
            this.Close();
            displayDetails.Show();
