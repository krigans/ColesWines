...
{
    /// <summary>
    /// Interaction logic for DisplaySpiritDetails.xaml
    /// </summary>
    public partial class DisplayMcWilliamsHanwood : Window
    {
        public static readonly DependencyProperty PageLeftEnabledProperty = DependencyProperty.Register(
           "PageLeftEnabled", typeof(bool), typeof(DisplayMcWilliamsHanwood), new PropertyMetadata(false));

        public static readonly DependencyProperty PageRightEnabledProperty = DependencyProperty.Register(
            "PageRightEnabled", typeof(bool), typeof(DisplayMcWilliamsHanwood), new PropertyMetadata(false));

        public static readonly RoutedEvent HandPointerEnterEvent = EventManager.RegisterRoutedEvent(
       "HandPointerEnter", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayMcWilliamsHanwood));

        public static readonly RoutedEvent HandPointerLeaveEvent = EventManager.RegisterRoutedEvent(
            "HandPointerLeave", RoutingStrategy.Direct, typeof(EventHandler<HandPointerEventArgs>), typeof(DisplayMcWilliamsHanwood));
       ...
       // Temp Help = new Temp();
        ...
        public DisplayMcWilliamsHanwood()
        {
            InitializeComponent();
        ...
        {
            unregisterEvents();
            var displayDetails = new DisplaySpirit();
            this.Close();
            displayDetails.Show();
